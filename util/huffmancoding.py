...
def huffman_encode_model(model, directory='encodings/'):
    ...
    for name, param in model.named_parameters():
        ...
        if 'weight' in name:
            ...
            num_weight = len(weight.reshape(-1))
            ...
            print(f"{name:<15} | {original:10} {compressed:10} {original / compressed:>10.2f}x {100 * compressed / original:>6.2f}% {compressed*8/num_weight:>6.2f}")
        else: # bias
    ...
    print('-'*70)
    print(f"{'total':15} | {original_total:>10} {compressed_total:>10} {original_total / compressed_total:>10.2f}x {100 * compressed_total / original_total:>6.2f}% {compressed_total*8/num_weight_total:>6.2f}")
