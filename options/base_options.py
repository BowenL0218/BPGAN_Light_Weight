...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--Dw_Index', type=str, default=None, help="index for layer to do DW deconvolution")

        self.parser.add_argument('--qint8', action='store_true', help='if specified, run model in qint8 mode')
        self.parser.add_argument('--noisy_activation', action='store_true', help='if True, add quantization noise to each ReLU layers')
        self.parser.add_argument('--load_pretrain', type=str, default='', help='load the pretrained model from the specified location')
        self.parser.add_argument('--fused_layers', action='store_true', help='if true, load fused models')
        self.parser.add_argument('--show_act_quant', action='store_true', help='if True, show activation before and after quantization')
        self.parser.add_argument('-f', type=str, default='', help='For Colab use')
